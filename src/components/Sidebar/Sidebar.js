...
const Sidebar = () => {
  ...
  return (
    ...
    <div className='sidebar-container flex-vt'>
       ...
       <span><input placeholder='add new label...' value={newLabel} className='addNewlabel-input' onChange={(e)=>setNewLabel(e.target.value)}/><button onClick={addNewLabel}  class="btn btn-floating-action"><i class="fa fa-plus"></i></button></span> 
